...
def get_parser():
    ...
    parser.add_argument(
        "-H", "--host", type=str, help="The database host", required=False,
    )

    parser.add_argument(
        "-d", "--database", type=str, help="The name of the database", required=False,
    )

    parser.add_argument(
        "-u", "--admin_user", type=str, required=False,
    )

    parser.add_argument(
        "-p", "--admin_password", type=str, required=False,
    )
