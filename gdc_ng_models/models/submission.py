...
class TransactionLog(Base):
    ...
    canonical_json = deferred(Column(JSONB, server_default="[]", nullable=False,))
...
class TransactionSnapshot(Base):
    ...
    old_props = Column(JSONB, nullable=False,)

    new_props = Column(JSONB, nullable=False,)
...
class TransactionDocument(Base):
    ...
    id = Column(
        Integer, primary_key=True, nullable=False, server_default=id_seq.next_value()
    )
